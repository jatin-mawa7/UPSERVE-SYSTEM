...
def receipt():
    ...
    if costoffoodvar.get() != '' or costofcakesvar.get() != '' or costofdrinksvar.get() != '':
        ...
        textReceipt.insert(END, '\t  UPSERVE BILLING SYSTEM\n')
        textReceipt.insert(END, '\tupservemanagement@gmail.com\n\n')
        textReceipt.insert(END, '***********************TAX INVOICE**********************\n\n')
...
root.title('UPSERVE A BILLING SYSTEM')

root.config(bg='#282634')
root.resizable(0,0)

topFrame = Frame(root, bd=10, relief=RIDGE, bg='#7a4251')
topFrame.pack(side=TOP)

labelTitle = Label(topFrame, text='UPSERVE BILLING SYSTEM', font=('arial', 30, 'bold'), fg='cornsilk', bd=9,
                   bg="#7a4251", width=51)
labelTitle.grid(row=0, column=0)

# frames

menuFrame = Frame(root, bd=10, relief=RIDGE, bg='#282634')
menuFrame.pack(side=LEFT)

costFrame = Frame(menuFrame, bd=4, relief=RIDGE, bg='#282634', pady=10)
costFrame.pack(side=BOTTOM)

foodFrame = LabelFrame(menuFrame, text='Food', font=('arial', 19, 'bold'), bd=10, relief=RIDGE, fg='#282634', )
foodFrame.pack(side=LEFT)

drinksFrame = LabelFrame(menuFrame, text='Drinks', font=('arial', 19, 'bold'), bd=10, relief=RIDGE, fg='#282634')
drinksFrame.pack(side=LEFT)

cakesFrame = LabelFrame(menuFrame, text='Cakes', font=('arial', 19, 'bold'), bd=10, relief=RIDGE, fg='#282634')
cakesFrame.pack(side=LEFT)

rightFrame = Frame(root, bd=15, relief=RIDGE, bg='#282634')
rightFrame.pack(side=RIGHT)

calculatorFrame = Frame(rightFrame, bd=1, relief=RIDGE, bg='#f44459')
calculatorFrame.pack()

recieptFrame = Frame(rightFrame, bd=4, relief=RIDGE, bg='#282634')
recieptFrame.pack()

buttonFrame = Frame(rightFrame, bd=3, relief=RIDGE, bg='#282634')
buttonFrame.pack()
...
labelCostofFood = Label(costFrame, text='Cost of Food', font=('arial', 16, 'bold'), bg='#282634', fg='white')
...
labelCostofDrinks = Label(costFrame, text='Cost of Drinks', font=('arial', 16, 'bold'), bg='#282634', fg='white')
...
labelCostofCakes = Label(costFrame, text='Cost of Cakes', font=('arial', 16, 'bold'), bg='#282634', fg='white')
...
labelSubTotal = Label(costFrame, text='Sub Total', font=('arial', 16, 'bold'), bg='#282634', fg='white')
labelSubTotal.grid(row=0, column=2)

textSubTotal = Entry(costFrame, font=('arial', 16, 'bold'), bd=6, width=14, state='readonly', textvariable=subtotalvar)
textSubTotal.grid(row=0, column=3, padx=41)

labelServiceTax = Label(costFrame, text='Service Tax', font=('arial', 16, 'bold'), bg='#282634', fg='white')
...
labelTotalCost = Label(costFrame, text='Total Cost', font=('arial', 16, 'bold'), bg='#282634', fg='white')
...
buttonTotal = Button(buttonFrame, text='Total', font=('arial', 14, 'bold'), fg='white', bg='#f44459', bd=3, padx=5,
                     command=totalcost)
buttonTotal.grid(row=0, column=0)

buttonReceipt = Button(buttonFrame, text='Receipt', font=('arial', 14, 'bold'), fg='white', bg='#f44459', bd=3, padx=5
                       , command=receipt)
buttonReceipt.grid(row=0, column=1)

buttonSave = Button(buttonFrame, text='Save', font=('arial', 14, 'bold'), fg='white', bg='#f44459', bd=3, padx=5
                    , command=save)
buttonSave.grid(row=0, column=2)

buttonReset = Button(buttonFrame, text='Reset', font=('arial', 14, 'bold'), fg='white', bg='#f44459', bd=3, padx=5,
                     command=reset)
buttonReset.grid(row=0, column=3)

buttonExit =Button(buttonFrame, text='Exit' , font=('arial',14,'bold'), fg= 'white', bg= '#f44459', bd=3,padx=5
...
button7 = Button(calculatorFrame, text='7', font=('arial', 16, 'bold'), fg='#ffecd1', bg='#f44459', bd=6, width=6,
                 command=lambda: buttonClick('7'))
button7.grid(row=1, column=0)

button8 = Button(calculatorFrame, text='8', font=('arial', 16, 'bold'), fg='#ffecd1', bg='#f44459', bd=6, width=6,
                 command=lambda: buttonClick('8'))
button8.grid(row=1, column=1)

button9 = Button(calculatorFrame, text='9', font=('arial', 16, 'bold'), fg='#ffecd1', bg='#f44459', bd=6, width=6
                 , command=lambda: buttonClick('9'))
button9.grid(row=1, column=2)

buttonPlus = Button(calculatorFrame, text='+', font=('arial', 16, 'bold'), fg='#ffecd1', bg='#f44459', bd=6, width=6
                    , command=lambda: buttonClick('+'))
buttonPlus.grid(row=1, column=3)

button4 = Button(calculatorFrame, text='4', font=('arial', 16, 'bold'), fg='#ffecd1', bg='#f44459', bd=6, width=6
                 , command=lambda: buttonClick('4'))
button4.grid(row=2, column=0)

button5 = Button(calculatorFrame, text='5', font=('arial', 16, 'bold'), fg='#ffecd1', bg='#f44459', bd=6, width=6
                 , command=lambda: buttonClick('5'))
button5.grid(row=2, column=1)

button6 = Button(calculatorFrame, text='6', font=('arial', 16, 'bold'), fg='#ffecd1', bg='#f44459', bd=6, width=6
                 , command=lambda: buttonClick('6'))
button6.grid(row=2, column=2)

buttonMinus = Button(calculatorFrame, text='-', font=('arial', 16, 'bold'), fg='#ffecd1', bg='#f44459', bd=6, width=6
                     , command=lambda: buttonClick('-'))
buttonMinus.grid(row=2, column=3)

button1 = Button(calculatorFrame, text='1', font=('arial', 16, 'bold'), fg='#ffecd1', bg='#f44459', bd=6, width=6
                 , command=lambda: buttonClick('1'))
button1.grid(row=3, column=0)

button2 = Button(calculatorFrame, text='2', font=('arial', 16, 'bold'), fg='#ffecd1', bg='#f44459', bd=6, width=6
                 , command=lambda: buttonClick('2'))
button2.grid(row=3, column=1)

button3 = Button(calculatorFrame, text='3', font=('arial', 16, 'bold'), fg='#ffecd1', bg='#f44459', bd=6, width=6
                 , command=lambda: buttonClick('3'))
button3.grid(row=3, column=2)

buttonMult = Button(calculatorFrame, text='*', font=('arial', 16, 'bold'), fg='#ffecd1', bg='#f44459', bd=6, width=6
                    , command=lambda: buttonClick('*'))
buttonMult.grid(row=3, column=3)

buttonAns = Button(calculatorFrame, text='Ans', font=('arial', 16, 'bold'), fg='#ffecd1', bg='#f44459', bd=6, width=6,
                   command=answer)
buttonAns.grid(row=4, column=0)

buttonClear = Button(calculatorFrame, text='Clear', font=('arial', 16, 'bold'), fg='#ffecd1', bg='#f44459', bd=6, width=6
                     , command=clear)
buttonClear.grid(row=4, column=1)

button0 = Button(calculatorFrame, text='0', font=('arial', 16, 'bold'), fg='#ffecd1', bg='#f44459', bd=6, width=6
                 , command=lambda: buttonClick('0'))
button0.grid(row=4, column=2)

buttonDiv = Button(calculatorFrame, text='/', font=('arial', 16, 'bold'), fg='#ffecd1', bg='#f44459', bd=6, width=6,
                   command=lambda: buttonClick('/'))
