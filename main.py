...
topFrame = Frame(root, bd=10, relief=RIDGE, bg='midnightblue')
topFrame.pack(side=TOP)

labelTitle = Label(topFrame, text='UPSERVE BILLING SYSTEM', font=('arial', 30, 'bold'), fg='cornsilk', bd=9,
                   bg="midnightblue", width=51)
labelTitle.grid(row=0, column=0)

# frames

menuFrame = Frame(root, bd=10, relief=RIDGE, bg='midnightblue')
menuFrame.pack(side=LEFT)

costFrame = Frame(menuFrame, bd=4, relief=RIDGE, bg='midnightblue', pady=10)
costFrame.pack(side=BOTTOM)

foodFrame = LabelFrame(menuFrame, text='Food', font=('arial', 19, 'bold'), bd=10, relief=RIDGE, fg='midnightblue', )
foodFrame.pack(side=LEFT)

drinksFrame = LabelFrame(menuFrame, text='Drinks', font=('arial', 19, 'bold'), bd=10, relief=RIDGE, fg='midnightblue')
drinksFrame.pack(side=LEFT)

cakesFrame = LabelFrame(menuFrame, text='Cakes', font=('arial', 19, 'bold'), bd=10, relief=RIDGE, fg='midnightblue')
cakesFrame.pack(side=LEFT)

rightFrame = Frame(root, bd=15, relief=RIDGE, bg='midnightblue')
rightFrame.pack(side=RIGHT)

calculatorFrame = Frame(rightFrame, bd=1, relief=RIDGE, bg='red4')
calculatorFrame.pack()

recieptFrame = Frame(rightFrame, bd=4, relief=RIDGE, bg='midnightblue')
recieptFrame.pack()

buttonFrame = Frame(rightFrame, bd=3, relief=RIDGE, bg='midnightblue')
buttonFrame.pack()
...
labelCostofFood = Label(costFrame, text='Cost of Food', font=('arial', 16, 'bold'), bg='midnightblue', fg='white')
...
labelCostofDrinks = Label(costFrame, text='Cost of Drinks', font=('arial', 16, 'bold'), bg='midnightblue', fg='white')
...
labelCostofCakes = Label(costFrame, text='Cost of Cakes', font=('arial', 16, 'bold'), bg='midnightblue', fg='white')
...
labelSubTotal = Label(costFrame, text='Sub Total', font=('arial', 16, 'bold'), bg='midnightblue', fg='white')
labelSubTotal.grid(row=0, column=2)

textSubTotal = Entry(costFrame, font=('arial', 16, 'bold'), bd=6, width=14, state='readonly', textvariable=subtotalvar)
textSubTotal.grid(row=0, column=3, padx=41)

labelServiceTax = Label(costFrame, text='Service Tax', font=('arial', 16, 'bold'), bg='midnightblue', fg='white')
...
labelTotalCost = Label(costFrame, text='Total Cost', font=('arial', 16, 'bold'), bg='midnightblue', fg='white')
